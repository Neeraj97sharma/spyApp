...
def add_status():
    ...
    if spy.current_status_message != None:
        ...
        print 'Currently No status Message \n'

    default = raw_input("Do you want to use the older status (y/n)? ")
...
def send_message():
    ...
    print "Image to hide Message is ready!"
...
if existing == "Y":
    ...
    if len(spy.name) > 0:
        spy.salutation = raw_input("Who are you Mr, Ms,Master ")
